...
<head>
    ...
    <title>Vehicle Break Down Assistance Management System: Between dates Report of orders</title>
       ...
       <?php include_once('includes/sidebar.php');?>
        ...
        <div class="page">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="javascript:void(0);">Roadside Assistance Professional Reports</a>
            </nav>
            <div class="container-fluid">            
                <div class="row clearfix">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="header">
                                <h2>Roadside Assistance Professionals Reports </h2>
                            </div>
                            
                            <div class="body">
                                <form id="basic-form" method="post" action="driverwise-reportsdetails.php">
