...
$ret="select Email from Motorists where Email=:email || MobileNumber=:mobnum || CustomerID=:driid";
...
$sql="insert into Motorists(CustomerID,Name,MobileNumber,Email,Address,Password)values(:driid,:name,:mobnum,:email,:address,:password)";
