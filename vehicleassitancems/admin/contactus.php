...
$mobnum=$_POST['mobnum'];
$email=$_POST['email'];
$sql="update PageText set PageTitle=:pagetitle,PageDescription=:pagedes,Email=:email,MobileNumber=:mobnum where  PageType='contactus'";
...
$sql="SELECT * from  PageText where PageType='contactus'";
$query = $dbh -> prepare($sql);
$query->execute();
