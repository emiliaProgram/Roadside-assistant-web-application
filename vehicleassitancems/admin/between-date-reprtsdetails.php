...
<head>
    ...
    <title>Vehicle Break Down Assistance Management System: All Request</title>
       ...
       <?php include_once('includes/sidebar.php');?>
        ...
        <div class="page">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="javascript:void(0);">Reports of booking requests</a>
            </nav>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <th>Status</th>
                                        ...
                                        <tbody>
                                            <tr>
                                               <?php
$sql="SELECT b.*, m.Email, m.MobileNumber, m.Name from  Bookings b INNER JOIN Motorists m ON m.CustomerID = b.CustomerID where date(DateofRequest) between '$fdate' and '$tdate'";
