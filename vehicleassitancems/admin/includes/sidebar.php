...
$sql="SELECT AdminName,Email,Department from  Admin where ID=:aid";
...
{               ?>
            ...
            <ul id="main-menu" class="metismenu">
				...
				<?php if($row->Department == "HR"){ ?>
				<!--<li><a href="costManagement.php"><i class="ti-home"></i><span>Dashboard</span></a></li>-->
                <li>
				...
				<li class="open-top">
                    ...
                    <ul>
                        ...
                        <li><a class="dropdown-item" href="driverwise-report.php">Service report</a></li>
                    </ul>
                </li>
				<?php }?> 
