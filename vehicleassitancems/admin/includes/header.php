...
<nav class="navbar custom-navbar navbar-expand-lg py-2">
    <div class="container-fluid px-0">
        ...
        <a href="dashboard.php" class="navbar-brand"><strong>ISIT950 Roadside</strong> Admin</a>
        <div id="navbar_main">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-xl py-0">
                        <div class="py-3 px-3">
                            <?php
$sql="SELECT * from Bookings  where Status is null";
...
{ 
  ...
  ?>
                            <a href="view-booking-detail.php?editid=<?php echo htmlentities ($row->ID);?>&&bookid=<?php echo htmlentities ($row->BookingNumber);?>" class="list-group-item list-group-item-action d-flex">
                                <div class="list-group-img"><span class="avatar bg-purple"><?php echo $row->BookingNumber;?></span></div>
                                <div class="list-group-content">
                                    <div class="list-group-heading"> <?php echo $row->Name;?><small><?php echo $row->DateofRequest;?></small></div>
