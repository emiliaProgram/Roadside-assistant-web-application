...
if(isset($_POST['submit']))
  {
   ...
   $assignee=$_POST['assignee'];
    ...
    $sql="insert into BookingStatus(BookingNumber,Remark,Status) value(:bookid,:remark,:status)";
    $query=$dbh->prepare($sql);
$query->bindParam(':bookid',$bookid,PDO::PARAM_STR); 
    $query->bindParam(':remark',$remark,PDO::PARAM_STR); 
    $query->bindParam(':status',$status,PDO::PARAM_STR); 
       $query->execute();
      $sql= "update Bookings set AssignTo=:assignee, Status=:status,Remark=:remark where ID=:eid";
                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                <div class="table-responsive">
                                    <?php
                  $eid=$_GET['editid'];
$sql="SELECT b.*, m.Email, m.MobileNumber, m.Name from  Bookings b INNER JOIN Motorists m ON m.CustomerID = b.CustomerID where b.ID=:eid";
$query = $dbh -> prepare($sql);
$query-> bindParam(':eid', $eid, PDO::PARAM_STR);
$query->execute();
...
$bookid=$_GET['bookid']; 
   if($status!=""){
$ret="select BookingStatus.Remark,BookingStatus.Status,BookingStatus.UpdationDate from BookingStatus where BookingStatus.BookingNumber =:bookid";
...
$sql2 = "SELECT * from   Professionals ";
...
<option value="<?php echo htmlentities($row->CustomerID);?>"><?php echo htmlentities($row->CustomerID
    );?></option>
 <?php } ?>
    </select></td>
  </tr> 
