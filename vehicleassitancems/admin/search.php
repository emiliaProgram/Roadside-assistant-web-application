...
$sql="SELECT b.*, m.Email, m.MobileNumber, m.Name from  Bookings b INNER JOIN Motorists m ON m.CustomerID = b.CustomerID where BookingNumber like '$sdata%' || m.Name like '$sdata%' || m.MobileNumber like '$sdata%'";
