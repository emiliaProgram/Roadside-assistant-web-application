...
$sql="delete from Motorists where ID=:rid";
...
<head>
    ...
    <title>Vehicle Break Down Assistance Management System: Manage Motorists</title>
       ...
       <?php include_once('includes/sidebar.php');?>
        ...
        <div class="page">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="javascript:void(0);">Mange Motorists</a>
            </nav>
            <div class="container-fluid">            
                <div class="row clearfix">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="header">
                                <h2><strong>Mange</strong> Motorists </h2>
                            </div>
                            <div class="body">
