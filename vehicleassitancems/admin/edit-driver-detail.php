...
$sql="update Motorists set Name=:name,MobileNumber=:mobnum,Email=:email,Address=:address where ID=:eid";
...
<html lang="en">
<head>
<title>Vehicle Break Down Assistance Management System: Update Driver</title>
                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                <form id="" method="post" novalidate>
                                    <?php
$eid=$_GET['editid'];
$sql="SELECT * from  Motorists where ID=$eid";
$query = $dbh -> prepare($sql);
$query->execute();
...
{               ?>
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="driid" value="<?php  echo htmlentities($row->CustomerID);?>" readonly='true' maxlength="10">
                                    </div>
                                    <div class="form-group">
                                        <label>Name</label>
