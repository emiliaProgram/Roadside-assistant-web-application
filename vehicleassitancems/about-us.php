            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <!-- about content start -->
                         <?php
$sql="SELECT * from PageText where PageType='aboutus'";
...
{               ?>
                        <div class="about-us-info">
                            <!--<p><?php  echo htmlentities($row->PageDescription);?></p>-->
                              <?php $cnt=$cnt+1;}} ?>
							  <p> We aim to widen our network of roadside assistant professionals and become Australia's largest network!
							  If you're interested, click here to put an <a href="jobseeker.php" target="_blank"> Application of Interest.</a></p>
                            <!-- about social start -->
                    ...
                    <div class="col-md-6 hidden-xs">
                        ...
                        <div class="about-us-img">
                            <img src="img1/about/bike.png" alt="" width="300" height="300">
                        </div>
                        <!-- about us img end -->
                    </div>
                </div>
